...
import AriseRobot.modules.sql.notes_sql as sql
from AriseRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from AriseRobot.__main__ import DATA_IMPORT
from AriseRobot.modules.helper_funcs.chat_status import user_admin
from AriseRobot.modules.helper_funcs.alternate import typing_action

# from AriseRobot.modules.rules import get_rules
import AriseRobot.modules.sql.rules_sql as rulessql

# from AriseRobot.modules.sql import warns_sql as warnssql
import AriseRobot.modules.sql.blacklist_sql as blacklistsql
from AriseRobot.modules.sql import disable_sql as disabledsql

# from AriseRobot.modules.sql import cust_filters_sql as filtersql
# import AriseRobot.modules.sql.welcome_sql as welcsql
import AriseRobot.modules.sql.locks_sql as locksql
...
def export_data(update, context):
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("AriseRobot{}.backup".format(chat_id), "rb"),
    ...
    os.remove("AriseRobot{}.AriseRobot".format(chat_id))  # Cleaning file
